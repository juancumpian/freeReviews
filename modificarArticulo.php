...
if(isset($_POST["titulo"])){
  ...
  $queryInsertar = $lnk->query(" UPDATE articulos SET  Titulo = '$titulo', Contenido = '$contenido', email='$email',id_categoria='$categoria' where id_articulo = '$id';");
...
if(isset($_GET["idArticulo"])){
    ...
    $idArticulo = $_GET["idArticulo"];
    $queryComprobar = $lnk->query("SELECT contenido, Titulo, id_categoria FROM articulos where id_articulo = '$idArticulo';");
...
<div class="container">
  <div id="editor">
      <form method="POST">
        ...
        <input placeholder="Inserta Título" class="form-control" type="text" name="titulo" id="titulo" value="<?= $titulo?>" required/>
